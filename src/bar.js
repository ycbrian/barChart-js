...
BarChart.prototype.prepareData = function() {
  ...
  chart.horizontalAxisWidth = chart.width - 2 * chart.horizontalMargin; // left and right maring
...
BarChart.prototype.drawVerticalLabels = function() {
  ...
  for (var i = 0; i <= chart.itemsNum; ++i) {
    ...
    var verticalLabelY =
      chart.verticalMargin + i * chart.scaledVerticalLabelFreq;
...
BarChart.prototype.drawHorizontalGuidelines = function() {
  ...
  for (var i = 0; i <= chart.itemsNum; ++i) {
    ...
    var horizontalGuidelineStartY =
      chart.verticalMargin + i * chart.scaledVerticalLabelFreq;

    // End point coordinates
    var horizontalGuidelineEndX =
      chart.horizontalMargin + chart.horizontalAxisWidth;
    var horizontalGuidelineEndY =
      chart.verticalMargin + i * chart.scaledVerticalLabelFreq;
...
BarChart.prototype.drawBars = function() {
  ...
  for (var i = 0; i < chart.itemsNum; ++i) {
    ...
    var barWidth =
      chart.horizontalLabelFreq - (2 * chart.horizontalLabelFreq) / 4;
    var barHeight =
